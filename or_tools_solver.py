...
class OrToolsModelAdapter:
    ...
    def eval(self, z3_var):
        ...
        # 1. 目的変数の評価（total_waste や total_operations）
        if hasattr(z3_var, 'sexpr') and ('total_waste' in z3_var.sexpr() or 'total_operations' in z3_var.sexpr()):
